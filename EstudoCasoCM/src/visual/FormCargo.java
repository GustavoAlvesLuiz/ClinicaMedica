...
public class FormCargo extends javax.swing.JDialog {
    ...
    public boolean validaCampos(){
        ...
        if(!(txtSalario.getText().length()>0)){
            JOptionPane.showMessageDialog(null, "Informe o salario do cargo!");
    ...
    private void initComponents() {
        ...
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${valorSalario}"));
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblCargo, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.codigoCargo}"), txtCodigo, org.jdesktop.beansbinding.BeanProperty.create("text"));
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblCargo, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.nomeCargo}"), txtNome, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblCargo, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.valorSalario}"), txtSalario, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        // TODO add your handling code here:
        trataEdicao(true);
        listCargo.add((Cargos)new Cargos());// cria um objeto e uma linha na tabela
        int linha = listCargo.size()-1;
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        Cargos objCargos = listCargo.get(linhaSelecionada);
        objDAOCargos.salvar(objCargos);
        atualizaTabela();
        }
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        if(opcao==0){
          int linhaSelecionada = tblCargo.getSelectedRow();
          Cargos objCargos = listCargo.get(linhaSelecionada);
          objDAOCargos.remover(objCargos);
          atualizaTabela();
          trataEdicao(false);
        }

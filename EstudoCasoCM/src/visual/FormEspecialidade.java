...
public class FormEspecialidade extends javax.swing.JDialog {
    ...
    public boolean validaCampos(){
        if(!(txtNome.getText().length()>0)){
            JOptionPane.showMessageDialog(null, "Informe o nome da especialidade!");
            txtNome.requestFocus();
            return false;
        }
        if(!(txtSalario.getText().length()>0)){
            JOptionPane.showMessageDialog(null, "Informe o salario da especialidade!");
    ...
    private void initComponents() {
        ...
        org.jdesktop.swingbinding.JTableBinding.ColumnBinding columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${codigoEspecialidade}"));
        ...
        columnBinding.setEditable(false);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${salarioEspecialidade}"));
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblEspecialidade, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.codigoEspecialidade}"), txtCodigo, org.jdesktop.beansbinding.BeanProperty.create("text"));
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblEspecialidade, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.nomeEspecialidade}"), txtNome, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblEspecialidade, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.salarioEspecialidade}"), txtSalario, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        // TODO add your handling code here:
        trataEdicao(true);
        listEspecialidade.add((Especialidades)new Especialidades());// cria um objeto e uma linha na tabela
        int linha = listEspecialidade.size()-1;
        tblEspecialidade.setRowSelectionInterval(linha, linha);// seleciona a linha
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        Especialidades objEspecialidades = listEspecialidade.get(linhaSelecionada);
        objDAOEspecialidades.salvar(objEspecialidades);
        atualizaTabela();
        }
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        if(opcao==0){
          int linhaSelecionada = tblEspecialidade.getSelectedRow();
          Especialidades objEspecialidades = listEspecialidade.get(linhaSelecionada);
          objDAOEspecialidades.remover(objEspecialidades);
          atualizaTabela();
          trataEdicao(false);
        }
